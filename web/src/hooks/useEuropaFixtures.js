...
async function loadGrouped() {
  ...
  const { data: fixtures, error: fixErr } = await supabase
    .from('fixtures')
    .select('id, league_id, matchday, home_team_name, away_team_name, home_team_short_name, away_team_short_name, home_team_badge, away_team_badge, kickoff_at, kickoff_confirmed, status, home_score, away_score, live_minute, referee, venue, highlight_video_url')
