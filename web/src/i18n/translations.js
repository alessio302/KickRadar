...
const de = {
  ...
  playerProfile: {
    ...
    tabGoalkeeping: 'Torwart',
    tabAttack: 'Angriff',
    tabDefense: 'Abwehr',
    tabDiscipline: 'Karten',
    matchPlayed: 'Spiele',
    goals: 'Tore',
    assists: 'Vorlagen',
...
const en = {
  ...
  playerProfile: {
    ...
    duelsWon: 'Duels Won',
    dribbleSucc: 'Successful Dribbles',
    saves: 'Saves',
    insideBoxSaves: 'Box Saves',
...
const it = {
  ...
  playerProfile: {
    ...
    tabGoalkeeping: 'Portiere',
    tabAttack: 'Attacco',
    tabDefense: 'Difesa',
    tabDiscipline: 'Cartellini',
    matchPlayed: 'Presenze',
    goals: 'Gol',
    assists: 'Assist',
...
const fr = {
  ...
  playerProfile: {
    ...
    statsAsOf: (d) => `Au ${d}`,
    tabOverview: 'Aperçu',
    tabGoalkeeping: 'Gardien',
    tabAttack: 'Attaque',
    tabDefense: 'Défense',
    tabDiscipline: 'Cartons',
    matchPlayed: 'Matchs',
    goals: 'Buts',
    assists: 'Passes déc.',
    ...
    saves: 'Arrêts',
    insideBoxSaves: 'Arrêts dans la surface',
...
const es = {
  ...
  playerProfile: {
    ...
    tabOverview: 'Resumen',
    tabGoalkeeping: 'Portero',
    tabAttack: 'Ataque',
    tabDefense: 'Defensa',
    tabDiscipline: 'Tarjetas',
    matchPlayed: 'Partidos',
    goals: 'Goles',
    assists: 'Asistencias',
    ...
    dribbleSucc: 'Regates exitosos',
    saves: 'Paradas',
    insideBoxSaves: 'Paradas en el área',
  ...
  standings: {
    ...
    goalDiff: 'DG',
    zoneChampionsLeague: 'Champions League',
    zoneEurope: 'Competiciones europeas',
