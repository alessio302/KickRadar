...
//
// Live A/B comparison of gemini-3.5-flash-lite vs gemini-3.6-flash on the
...
// ones -- see the accompanying investigation). gemini-2.0-flash, the
// original comparison target, has since been retired by Google (404,
// recommending gemini-3.6-flash as the replacement). RESPONSE_SCHEMA and
...
// Same throttling pattern as llmExtract.js, recalculated for the lower cap:
// gemini-3.6-flash's free tier is 10 req/min (vs. 15 for
// gemini-3.5-flash-lite), i.e. a 6s/request ceiling. 6.5s apart leaves the
// same kind of margin llmExtract.js keeps over its own 15/min ceiling
// (4.2s vs. an exact 4s/request), giving ~9.2 calls/min here.
