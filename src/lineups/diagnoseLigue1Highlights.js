// Temporary diagnostic: check the Ligue 1 YouTube playlist the user found,
// same check already done for Bundesliga/Premier League/LaLiga before
// being folded into the real implementation.
const PLAYLIST_ID = 'PLfMaQ6y8PUiM';
