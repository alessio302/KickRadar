...
-- Full match-event timeline (goals/cards/subs) per fixture, for the
-- "Spielinfo" tab -- fetched exactly once per fixture, right after it
-- finishes (see syncLineups.js and fixtures.events_synced_at).
